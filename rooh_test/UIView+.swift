...
extension UIView {
    ...
    // MARK: - Color Methods
    func addNeumorphicShadow(radius: CGFloat = 30, bgColor: String = "NeumorphicBackground") {
        self.layer.sublayers?.filter { $0.name == "neumorphicShadow" }.forEach { $0.removeFromSuperlayer() }
